...
$players = [
  ...
  2 => ['PDZIKA', 'BAIANO', 'LEOZOX', 'KUSH', 'LEVI', 'LULU', 'POWERZIN', 'FOFÃO', 'TODDY', 'DNLZIN'],
  3 => ['XAUS', 'JONAS', 'SANTIAGO', 'NEGOTRUFA', 'PREDRAZA', 'JOTAV', 'AK-AIRON'],
  4 => ['JV (PUTIFERO)', 'PIXELCOPATA', 'FALKES', 'LEE', 'GRIMM', 'MOREL', 'AVESTRUZ'],
